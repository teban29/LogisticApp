...
export default function Sidebar({ open, setOpen }) {
  ...
  const items = [
    ...
    { to: "/usuarios", label: "Usuarios", icon: <RiUser3Line /> },
    { to: "/clientes", label: "Clientes", icon: <RiTeamLine /> },
    { to: "/proveedores", label: "Proveedores", icon: <RiBuilding2Line /> },
    { to: "/inventario", label: "Inventario", icon: <RiArchive2Line /> },
    { to: "/envios", label: "Envíos", icon: <RiTruckLine /> },
    { to: "/configuracion", label: "Configuración", icon: <RiSettings3Line /> },
  ];
    ...
    <aside
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold">LogísticApp</span>
        </div>
        <button
